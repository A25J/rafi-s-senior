...
if($_SESSION['admin_sid'] == session_id()) {
    ...
    if (isset($_SESSION['role'])) {
        ...
        $result = mysqli_query($con, "SELECT role FROM users WHERE id = ".$_SESSION['user_id']);
...
<body>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © rafi abou elezz  <a class="grey-text text-lighten-4" href="#" target="_blank">Students</a> All rights reserved.</span>
        </div>
    </div>
  </footer>
